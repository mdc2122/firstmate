...
test_away_record_permits_any_green_merge_under_away_authority() {
  ...
  # A yolo=on task still merges under its own standing authority: the ledger
  # records yolo, the tag the task's recorded posture resolved to.
  ...
  pass "while the away-posture record exists a green merge lands under away authority unless the task's own yolo posture resolves first, and attended merges stay untagged"
}
